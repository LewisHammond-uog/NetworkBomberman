...
namespace reactphysics3d {
    ...
    public:
        ...
        /// Overloaded operator
        Vector3& operator=(const Vector3& vector);
        Vector3& operator=(const glm::vec3 glmVector);
    ...
    //Glm Vector Contructor
    inline Vector3::Vector3(glm::vec3 vector) : x(vector.x), y(vector.y), z(vector.z)
    {
    ...
    inline Vector3& Vector3::operator=(const glm::vec3 glmVector)
    {
        x = glmVector.x;
        y = glmVector.y;
        z = glmVector.z;
